  ...
  return (
    <div>
            <h5 className=" w-full text-center text-gray-700 text-2xl cursor-pointer">
                <i onClick={()=>{props.setRidePopupPanel(false)}}  className="ri-arrow-down-wide-line"></i>
            </h5>


            <h3 className="text-2xl w-full text-center font-semibold mb-5">New Ride Avaliable</h3>
        <div className='flex items-center justify-between gap-2 mb-3 bg-gray-50 rounded-lg'>
            ...
            <div className="flex flex-col gap-4 gap-y-6 justify-between  items-center w-full">
                ...
                <button onClick={()=>{props.setConfirmRidePopupPanel(true);props.setRidePopupPanel(false)}} className="w-full bg-green-600 text-white font-bold py-2 rounded-lg">Accept</button>
                <button onClick={()=>{props.setRidePopupPanel(false)}} className="w-full bg-gray-300 text-gray-700 font-bold py-2 rounded-lg">Ignore</button>
