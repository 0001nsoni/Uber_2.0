  ...
  return (
    <div className='p-7 h-screen flex flex-col justify-between'>
      <div>
        ...
        <button className='bg-[#111] rounded px-4 py-2  w-full text-lg text-white mb-7'>Sign Up</button>
      </form>
      <p className='text-center'>Alread have a account? <Link to={"/captain-login"} className='text-blue-600'>Login Here</Link></p>
      </div>
      <div>
